 ...
 * <p>3. 提供添加和移除请求的方法：通过 {@link #addPendingRequest(String, CompletableFuture)} 和 {@link #removePendingRequest(String)} 方法来管理请求与响应的映射关系。</p>
 *
 * <p>使用示例：</p>
